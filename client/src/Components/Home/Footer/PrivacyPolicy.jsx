            ...
            <div>
                ...
                <ol>
                    <li>
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                payment made or attempted to be made to our company via credit card,
                                cheque or bank transfer to use our services. This includes,
                                but is not limited to, name, address, email address, phone number,
                    ...
                    <li>
                        ...
                        <ol>
                            <li>
                                ...
                                publishing business information to maximize the reach of the businesses
                                registered with us, it is safe to assume that all "Business Information"
                                will be publicly available on the site and therefore can be accessed by
                                any Internet User. All Business information that you disclose to our site
                                automatically becomes accessible to the public information.
                                So you are requested to take care in disclosing any information that are
                                copyrighted or covered under any confidentiality agreement.
                                We reserve the right to publish the data in any format that we feel is necessary
                                which includes, but is not limited to, any of our sites, print media, CDs,
                                DVDs and any media known or not known today. This information may also be
                                shared with authorised agents who sell our services or provide support to our
                                customers and with verification agencies for the purpose of third party
                                verification of the Business Information.
                            </li>
                            <li>
                                <b> Payment Information: </b> These details are never disclosed to anybody other than if required by law.
                    ...
                    <li>
                        ...
                        <ol>
                            <li>
                                We reserve the right to disclose the "Information Gathered" if required by law or if we feel not
                                revealing such information would be detrimental to our interest or the interests of our users.
                            </li>
                        </ol>
                    </li>

                    <li>
                        <b>Modification/Deletion Requests of your Business Information</b>
                        <ol>
                            <li>
                    ...
                    <li>
                        ...
                        <ol>
                            <li>
                                Our Site may provide hyperlinks, which takes you to content, products and/or services offered by
                                third parties, like websites of our member companies, etc. You are assumed to read such sites'
                                privacy policies, terms of use and/or terms and conditions before using such sites. Our site has
                                no control over such third party's web sites and we are not responsible or liable to anyone for
                                such web sites, or their content, products or services.
                            </li>
                        </ol>
                    </li>
                    ...
                    <li>
                        ...
                        <ol>
                            <li>
                                We use cookies to identify you on our website. Most login based sites use cookies and this is quite normal.
                            </li>
                        </ol>
                    </li>
                    ...
                    <li>
                        ...
                        <ol>
                            <li>
                                We take measures to protect our data that contains information related to you.
                                However, as a consideration for viewing this site or interacting with this site in any manner,
                                you waive all claims of any nature against this site concerning the loss, alteration, or misuse
                                of information.
                            </li>
                        </ol>
                    </li>
                    ...
                    <li>
                        <b> Revisions to This Policy </b>
                        <ol>
                            <li>
                                This Privacy Policy is dynamic. It will continually change. You may not assume that it remains
                                the same and you agree to check the policy each time you visit the site for changes.
